...
- Latest local artifact verification before the current documentation updates: two clean-archive builds at exact source SHA `b608f7e4ac34c129c78cbf739f79625e107d0a4f` with `SOURCE_DATE_EPOCH=1790230368` produced identical wheel (`98,545` bytes; SHA-256 `ac9b7a16fb9f9703c008d90c6dd31273089a569385fe825dc2c37b659ab36a55`) and sdist (`328,108` bytes; SHA-256 `ba7e28464fe0cf05ee67ccd9ef3a1f287b8ac89bd810055a376ad25ae536433b`). `twine check`, `check-wheel-contents`, and the sdist content contract passed. The exact wheel installed in a clean venv and the exact sdist in an isolated target with the local build backend; both passed `--version`, `doctor --json`, and `smoke-test --json` on macOS arm64, Python 3.14.6, FFmpeg 9.0.1. This is local evidence only. The current progress/checklist updates change the sdist; rebuild from the final release SHA. No hosted OS matrix, attestation, tag, or publication exists for this build.
