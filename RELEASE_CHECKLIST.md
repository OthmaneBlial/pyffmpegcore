...
- Latest local artifact verification before the current documentation update: two builds at exact source SHA `62a213202ae2fc128c5a4745065cfe849f03ec6b` from the worktree and a clean `git archive`, with `SOURCE_DATE_EPOCH=1790231468`, produced identical wheel (`99,169` bytes; SHA-256 `0f83b2d2d1c2b0c9ef26b07208c35faf39fbe3d2fe776d3dfc64211ce3d0d655`) and sdist (`330,567` bytes; SHA-256 `25b1a2925e87f788fc5a3fbef8d0952554a4ee25aa65ec13b17ea8d53a40c642`). `twine check`, `check-wheel-contents`, and the 270-path sdist content contract passed. Both exact artifacts installed offline into isolated targets and passed `--version`, `doctor --json`, and `smoke-test --json` on macOS arm64, Python 3.14.6, FFmpeg 9.0.1. This is local evidence only. The current progress/checklist update changes the sdist; rebuild from the final release SHA. No hosted OS matrix, attestation, tag, or publication exists for this build.
