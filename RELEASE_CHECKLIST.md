...
- Latest locally rebuilt candidate: two builds from exact source SHA `259e5ffab26e0b5183dda6457ae826284da19d17` produced identical wheel (`96,740` bytes; SHA-256 `44cbaa62a003f721730ff5dd242adfa90ce8feb640c071bcfb05dbf472439c1a`) and sdist (`316,400` bytes; SHA-256 `21196c4412d84117995038606a15299cbc86b8809d21eaaf1b7cd1fdf4c8f320`). `twine check` passed. The wheel installed offline in a clean venv; the sdist installed offline into an isolated target directory. Both passed `--version`, `doctor --json`, `smoke-test --json`, and owner-only receipt creation on macOS. This is local evidence only; it has no hosted OS matrix, attestation, tag, or publication.
