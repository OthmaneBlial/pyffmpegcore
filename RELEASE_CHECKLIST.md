...
- [ ] `twine check`, wheel contents, sdist contents, and clean isolated wheel installation pass for the latest candidate. These passed for local artifacts at `ba981e9` and the older hosted run `35941884095`; rebuild and repeat on final release SHA.
