...
- Latest local artifact verification before this documentation update: exact source SHA `6e7c88c33c5409464e76fade218fa2a521869f41`, built from the worktree and clean `git archive` with `SOURCE_DATE_EPOCH=1790232488`, produced identical `0.3.0` wheel (99,241 bytes; SHA-256 `85414184db971635ce7a8fc30f5677f9eb8df412480f711e3c691b5159cfe5af`) and sdist (332,058 bytes; SHA-256 `b773fbd47a73b60cbd6d64dea48e10a3dbdb57a05af7429c63108bfbc42b76dd`). `twine check`, `check-wheel-contents`, the 270-file sdist contract, and offline pip installs passed; both exact artifacts passed `--version`, `doctor --json`, and `smoke-test --json`. A temporary `pipx 1.17.6` environment installed the exact wheel offline and passed the same checks. CodeQL [35966274580](https://github.com/OthmaneBlial/pyffmpegcore/actions/runs/35966274580) and Scorecard [35966274643](https://github.com/OthmaneBlial/pyffmpegcore/actions/runs/35966274643) passed on that SHA. This is local evidence only; `uv` is not installed here, and this documentation update changes the sdist, so rebuild from the final release SHA. Full CI, cross-platform matrix, attestation, tag, and publication remain open.
