...
class TestFFmpegRunner:
    ...
    def test_convert(self, mock_run):
        ...
        runner = FFmpegRunner()
        runner.convert("input.mp4", "output.avi", video_codec="libx264")
    ...
    def test_resize(self, mock_run):
        ...
        runner = FFmpegRunner()
        runner.resize("input.mp4", "output.mp4", 640, 480)
    ...
    def test_compress(self, mock_run):
        ...
        runner = FFmpegRunner()
        runner.compress("input.mp4", "output.mp4", crf=28)
    ...
    def test_compress_with_progress_callback(self, mock_run):
        ...
        runner.compress("input.mp4", "output.mp4", crf=28, progress_callback=callback)
    ...
    def test_convert_audio_only(self, mock_run):
        ...
        runner = FFmpegRunner()
        runner.convert("input.mp4", "output.mp3", audio_only=True, audio_codec="mp3")
    ...
    def test_convert_with_threads(self, mock_run):
        ...
        runner = FFmpegRunner()
        runner.convert("input.mp4", "output.mp4", threads=4)
    ...
    def test_resize_with_pix_fmt_override(self, mock_run):
        ...
        runner = FFmpegRunner()
        runner.resize("input.mp4", "output.mp4", 640, 480, pix_fmt="rgb24")
    ...
    def test_compress_single_pass_bitrate_mode(self, mock_run):
        ...
        runner = FFmpegRunner()
        runner.compress("input.mp4", "output.mp4", video_bitrate="1000k")
    ...
    def test_compress_two_pass_with_overhead_pct(self, mock_run, mock_probe):
        ...
        runner = FFmpegRunner()
        runner.compress("input.mp4", "output.mp4", target_size_kb=10240, overhead_pct=2.0)
    ...
    def test_compress_copy_codec_single_pass(self, mock_run):
        ...
        runner = FFmpegRunner()
        runner.compress("input.mp4", "output.mp4", crf=23, video_codec="copy")
    ...
    def test_convert_with_progress_callback(self, mock_run):
        ...
        runner.convert("input.mp4", "output.mp4", progress_callback=callback)
