...
- Conversion plans warn when default stream selection omits additional streams; the `--explain` rendering and audio-only case have regression coverage.
