...
- The benchmark now reports in-process planner time and direct FFprobe versus CLI probe time separately. On this macOS arm64 host, five-repeat medians were 0.000149 s for conversion planning, 0.039729 s for FFprobe, and 0.170483 s for CLI probe; CLI minus FFprobe was 0.130754 s, including CLI startup. Startup overhead was 0.089919 s; synthetic thumbnail overhead was 0.499765 s; pipeline cache cold/warm times were 0.961882/0.411318 s. Strict thresholds passed; these single-host synthetic measurements are not compatibility claims.
