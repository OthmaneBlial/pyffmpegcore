...
- Managed `--preserve-all-streams` execution now compares FFprobe input/output stream type, codec, and language. Mismatches fail validation; remote or unprobeable inputs are marked unverified. Receipts retain the comparison. Twenty-three focused workflow, receipt, and real-media tests passed; Ruff, formatting, mypy, generated docs, and Markdown link checks passed locally.
