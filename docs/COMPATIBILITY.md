...
In [run `35447046421`](https://github.com/OthmaneBlial/pyffmpegcore/actions/runs/35447046421), all six media smoke jobs, the Linux Python 3.10–3.14 package-contract jobs, and the compatibility-summary job passed. The six media jobs installed the **same prebuilt wheel** (`pyffmpegcore-0.2.2-py3-none-any.whl`, SHA-256 `c5a00fc636b62f4b1e1b23c1db6505f6dd9f900eb244f6f5d6c36794837b529d`). This is a CI artifact from `3a7315d`, not the published `0.2.2` wheel. Each artifact reports 22/22 successful steps, including quickstart, probe, conversion, stream preservation, audio extraction, thumbnails, five profiles, batch, and pipeline. The [generated Markdown artifact](https://github.com/OthmaneBlial/pyffmpegcore/actions/runs/35447046421) records every cell and its capability gaps.
