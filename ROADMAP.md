...
- [x] Publish a pinned, multi-architecture GHCR image containing a documented FFmpeg build only after licensing, codec, update, SBOM, and vulnerability-maintenance review.
- [x] Offer a GitHub Action that runs a versioned pipeline and uploads receipts/output artifacts; pin the container and action by digest/SHA.
