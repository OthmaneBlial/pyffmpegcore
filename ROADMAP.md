...
sortie JSON syntaxiquement invalide, une structure de stream incorrecte ou un
index de stream mal typé deviennent des erreurs d'exécution stables ; `probe`
renvoie le code CLI 5. Quatre tests de régression couvrent le runner et le CLI ;
ils simulent FFprobe, sans prétendre tester un fichier média corrompu réel.
...
Le même clip a ensuite vérifié la recette exact-size : la nouvelle détection
des pistes a supprimé la réserve audio inexistante et l'exigence AAC. À une
limite de 1 MiB, la réserve par défaut de 5 % a dépassé la limite de 7 803
...
Les
tests CLI, migration et écriture concurrente de receipt passent localement. Sur
le SHA exact `c801b90692f4d32f797602a1aeb096a74701802e`, CodeQL
[`35957295722`](https://github.com/OthmaneBlial/pyffmpegcore/actions/runs/35957295722)
et Scorecard
...
Les transformations dont la sortie principale est déterministe déclarent aussi
leurs pistes attendues ; la concat copy mappe toutes les pistes et compare son
...
du SHA `358d087` a été publié sur GitHub Pages par le commit
[`e77f1ac`](https://github.com/OthmaneBlial/OthmaneBlial.github.io/commit/e77f1ac3c25f972c10456a9a527dbda7972d7293).
La construction Pages est passée ; l'accueil public, `quickstart`,
...
schémas. La touche Flèche droite a aussi basculé vers `slate`, puis vers
